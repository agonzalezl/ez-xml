...
class Invoice(EzXMLModel):
    ...
    ReceiptDocumentReference: str | None = EzField("cac", default=None)
    StatementDocumentReference: str | None = EzField("cac", default=None)
    OriginatorDocumentReference: str | None = EzField("cac", default=None)
    ContractDocumentReference: str | None = EzField("cac", default=None)
    AdditionalDocumentReference: str | None = EzField("cac", default=None)
    ProjectReference: str | None = EzField("cac", default=None)
    Signature: str | None = EzField("cac", default=None)
    AccountingSupplierParty: AccountingSupplierParty
    AccountingCustomerParty: AccountingCustomerParty
    PayeeParty: str | None = EzField("cac", default=None)
    BuyerCustomerParty: str | None = EzField("cac", default=None)
    SellerSupplierParty: str | None = EzField("cac", default=None)
    TaxRepresentativeParty: str | None = EzField("cac", default=None)
    Delivery: str | None = EzField("cac", default=None)
    DeliveryTerms: str | None = EzField("cac", default=None)
    PaymentMeans: str | None = EzField("cac", default=None)
    PaymentTerms: str | None = EzField("cac", default=None)
    PrepaidPayment: str | None = EzField("cac", default=None)
    AllowanceCharge: str | None = EzField("cac", default=None)
    TaxExchangeRate: str | None = EzField("cac", default=None)
    PricingExchangeRate: str | None = EzField("cac", default=None)
    PaymentExchangeRate: str | None = EzField("cac", default=None)
